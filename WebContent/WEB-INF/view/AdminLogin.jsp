	...
	<form action="adminlogin.action" method="post" id="loginForm">
		...
		<div class="forgot">
			<div class="checkbox mb-3">
				<button type="button" class="btn btn-default" onclick="location.href='findidadminform.action'">Find ID</button>
				<button type="button" class="btn btn-default" onclick="location.href='findpwadminform.action'">Find Password</button>
			</div>
		</div>
		
		<button class="w-100 btn btn-lg btn-primary" type="submit">Sign in</button>
		
		<p class="mt-5 mb-3 text-muted"><a href="loginform.action" class="link-admin">sign in User</a></p>
	</form>
</main>
