		...
		<div class="input-form col-md-12 mx-auto">
			...
			<hr>
         		...
         		<div class="row">
	         		...
	         		<img src="${list.givePhoto }" /> 
	         		</div>
	         		<div class="col-md-2">
	         		${list.givemember }
	         		<c:if test="${list.givemember == nikName}">
	         			(나)
	         		</c:if>
	         		</div>
	         		<div class="col-md-1 ">
	         		 ...
	         		 <div class="col-md-1 photo">
	         		<img src="${list.takePhoto  }" />
	         		</div>
	         		<div class="col-md-2 ">
	         		 ${list.takemember }
	         		 </div>
	         		 <c:if test="${list.takemember == nikName}">
	         			(나)
	         		</c:if>
	         		<div class="col-md-5">
	         			<span class="money" style="font-weight: bold;">
	         			<fmt:formatNumber groupingUsed="true" value="${list.cost}">
				...
				<div class="col-md-6 p-5">
         		<h4 class="mb-3 head">개인별 지출 내역</h4> 
         		<hr>
         		<c:forEach var="dto" items="${sumCost }">
         		<div class="people">
         		<div class="row">
	         		<div class="col-md-1 photo"><img src="${dto.photo }" ></div>
	         		<div class="col-md-5 ">${dto.nikname } 
	         		<c:if test="${dto.nikname == nikName}">
	         			(나)
	         		</c:if> </div>
	         		<div class="col-md-6 ">
	         			<span class="money"  style="font-weight: bold">
