...
public class NotUserRoomListDTO
{
	// 주요 속성 구성
	...
	String room_title, budget, budget_min, budget_max, start_loc_lat, start_loc_lng, start_loc_date, final_go_date, room_del_date, mem_curr;
	String pw_code;
